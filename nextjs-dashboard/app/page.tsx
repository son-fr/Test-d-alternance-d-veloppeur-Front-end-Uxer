    ...
    <div className={`${first_page["first_page"]}`}>
      <main className={`${first_page["main"]}`} >
        <div className={`${first_page["button_list"]}`}>
          <ButtonComponent aria_label="button Valider" size="M" style='Primary' text="Valider" badge='3' leading_icon={CheckIcon} />
          <ButtonComponent aria_label="button Filtrer" size="M" style='Secondary' text="Filtrer" badge='3' leading_icon={SlidersHorizontalIcon} />
